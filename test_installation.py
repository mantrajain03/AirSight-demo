...
def test_imports():
    ...
    try:
        ...
        print(f"[FAIL] Failed to import SciPy: {e}")
        return False
...
def test_airsight_modules():
    ...
    try:
        ...
        print("[OK] Feature extractors imported successfully")
    except ImportError as e:
        print(f"[FAIL] Failed to import feature extractors: {e}")
        return False
    
    try:
        from airsight.core.visibility_analyzer import VisibilityAnalyzer
        print("[OK] Visibility analyzer imported successfully")
    except ImportError as e:
        print(f"[FAIL] Failed to import visibility analyzer: {e}")
        return False
    
    try:
        from airsight.core.video_processor import VideoProcessor
        print("[OK] Video processor imported successfully")
    except ImportError as e:
        print(f"[FAIL] Failed to import video processor: {e}")
        return False
    
    try:
        from airsight.visualization.visualizer import Visualizer
        print("[OK] Visualizer imported successfully")
    except ImportError as e:
        print(f"[FAIL] Failed to import visualizer: {e}")
        return False
...
def test_basic_functionality():
    ...
    try:
        ...
        print("[OK] Visibility analyzer works correctly")
...
if __name__ == "__main__":
    ...
    if not test_airsight_modules():
        all_passed = False
        print("\n[WARNING] AirSight modules not found. Make sure you're in the correct directory.")
        sys.exit(1)
    ...
    print("\n" + "=" * 60)
    print("[OK] All tests passed! AirSight is ready to use.")
    print("=" * 60)
    print("\nNext steps:")
